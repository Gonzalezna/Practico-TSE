...
a persistence unit "practico-tsePersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "practico-tse/pom.xml":
...
artifacts ("practico-tse-ejb.jar" and "practico-tse-web.war") are already built. You can build
